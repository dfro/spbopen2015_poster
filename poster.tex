...
%    \item Schottky contact is usually used in capacitance-voltage characterisation         
    \item Formation of reliable Schottky contact to InAs is difficult due to charge  accumulation at the surface.
    \item Electrolyte can be used to form Schottky-like barrier junction to InAs.
    \item But electrolyte based capacitance-voltage measurements give higher concentration comparing to Hall measurements.
\end{itemize}
...
\centering{
\figfont
\includesvg[clean, width=0.65\columnwidth]{images/sem_el}
